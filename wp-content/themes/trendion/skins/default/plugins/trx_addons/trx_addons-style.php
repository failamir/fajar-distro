...
if ( ! function_exists( 'trendion_trx_addons_get_css' ) ) {
	add_filter( 'trendion_filter_get_css', 'trendion_trx_addons_get_css', 10, 2 );
	function trendion_trx_addons_get_css( $css, $args ) {
