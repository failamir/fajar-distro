...
if ( ! function_exists( 'trendion_gutenberg_get_css' ) ) {
	add_filter( 'trendion_filter_get_css', 'trendion_gutenberg_get_css', 10, 2 );
	function trendion_gutenberg_get_css( $css, $args ) {
