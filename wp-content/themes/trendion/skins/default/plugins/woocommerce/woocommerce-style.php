...
if ( ! function_exists( 'trendion_woocommerce_get_css' ) ) {
	add_filter( 'trendion_filter_get_css', 'trendion_woocommerce_get_css', 10, 2 );
	function trendion_woocommerce_get_css( $css, $args ) {
