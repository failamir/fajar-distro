...
WordPress version: required at least 4.5, tested up to 5.8.2
...
Please install and activate it before starting to use the theme Trendion.
...
Theme documentation is available on http://trendion.axiomthemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Trendion is Fontello.
