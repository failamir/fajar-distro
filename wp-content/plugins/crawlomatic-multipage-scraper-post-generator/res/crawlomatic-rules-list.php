                                       ...
                                       <table class="responsive cr_main_table_nowr">
                                          ...
                                          <tr>
                                             <td>
                                                <div>
                                                   <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                      <div class="bws_hidden_help_text_top cr_min_260px"><?php echo esc_html__("Chose if you want to scrape also the product variations found in the scraped pages. Currently this feature is supported if scraping Shopify and WooCommerce store products.", 'crawlomatic-multipage-scraper-post-generator');?>
                                                      </div>
                                                   </div>
    ...
    if (!empty($rules)) {
     ...
     <div class="codemodalfzr-content">
       ...
       if(isset($crawlomatic_Main_Settings['bing_auth']) && $crawlomatic_Main_Settings['bing_auth'] != '')
       {
           ...
           <div>
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                           <div class="bws_hidden_help_text_top cr_min_260px">' . esc_html__("Chose if you want to scrape also the product variations found in the scraped pages. Currently this feature is supported if scraping Shopify and WooCommerce store products.", 'crawlomatic-multipage-scraper-post-generator') . '
                           </div>
                       </div>
